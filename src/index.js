...
fetch(
  `https://tangua.processolegislativo.com.br/integracao/?Parlamentares/${anoAtual}/json`
)
...
const buscarProcessos = () => {
  fetch(
    `https://tangua.processolegislativo.com.br/integracao/?Processos/0/${dadosUrl.id}/0/${anoAtual}`
  )
    .then((reponse) => reponse.json())
...
const buscarComissoes = () => {
  fetch(
    `https://tangua.processolegislativo.com.br/integracao/?Comissoes/${dadosUrl.id}/0/${anoAtual}`
  )
    .then((reponse) => reponse.json())
    .then((json) => {
...
const escreveProcessos = (processos) => {
  ...
  processos.forEach((processo) => {
    ...
    style='
      ...
      // '
    >
    <p><div class="button"><a class="meulink" href='https://tangua.processolegislativo.com.br/areapublica/documento/?Processo/${processo.Processo.replace(
      "/",
      "_"
    )}' target="_blank">
...
fetch(
  `https://tangua.processolegislativo.com.br/integracao/?Parlamentares/${anoAnterior}/json`
)
  .then((reponse) => reponse.json())
  .then((json) => {
    let parlamentares = json.Parametros;
...
const buscarProcessosAnoAnterior = () => {
  fetch(
    `https://tangua.processolegislativo.com.br/integracao/?Processos/0/${dadosUrl.id}/0/${anoAnterior}`
  )
    .then((reponse) => reponse.json())
...
const escreveProcessosAnoAnterior = (processoAnoAnterior) => {
  ...
  processoAnoAnterior.forEach((processoAnoAnterior) => {
    ...
    style='
      ...
      '
    >
    <p><div class="button"><a class="meulink" href='https://tangua.processolegislativo.com.br/areapublica/documento/?Processo/${processoAnoAnterior.Processo.replace(
      "/",
      "_"
    )}' target="_blank">
...
fetch(
  `https://tangua.processolegislativo.com.br/integracao/?Parlamentares/${doisAnosAtras}/json`
)
  .then((reponse) => reponse.json())
  .then((json) => {
    let parlamentares = json.Parametros;
...
const buscarProcessos2anosAtras = () => {
  fetch(
    `https://tangua.processolegislativo.com.br/integracao/?Processos/0/${dadosUrl.id}/0/${doisAnosAtras}`
  )
    .then((reponse) => reponse.json())
...
const escreveProcessos2anosAtras = (processos2AnosAtras) => {
  ...
  processos2AnosAtras.forEach((processos2AnosAtras) => {
    ...
    style='
      ...
      '
    >
    <p><div class="button"><a class="meulink" href='https://tangua.processolegislativo.com.br/areapublica/documento/?Processo/${processos2AnosAtras.Processo.replace(
      "/",
      "_"
    )}' target="_blank">
...
fetch(
  `https://tangua.processolegislativo.com.br/integracao/?Parlamentares/${tresAnosAtras}/json`
)
  .then((reponse) => reponse.json())
  .then((json) => {
    let parlamentares = json.Parametros;
...
const buscarProcessos3AnosAtras = () => {
  fetch(
    `https://tangua.processolegislativo.com.br/integracao/?Processos/0/${dadosUrl.id}/0/${tresAnosAtras}`
  )
    .then((reponse) => reponse.json())
...
const escreveProcessos3AnosAtras = (processos3AnosAtras) => {
  ...
  processos3AnosAtras.forEach((processo3AnosAtras) => {
    ...
    style='
      ...
      '
    >
    <p><div class="button"><a class="meulink" href='https://tangua.processolegislativo.com.br/areapublica/documento/?Processo/${processo3AnosAtras.Processo.replace(
      "/",
      "_"
    )}' target="_blank">
